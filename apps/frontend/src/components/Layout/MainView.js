  ...
  return (
    <div className="spotify-gradient-blue min-h-full p-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <Droppable id="search-results" isDropDisabled={true}>
      ...
      <div>
        ...
        {!isAdded && (
          <button
            ...
            className="absolute top-6 right-6 w-10 h-10 bg-[#1DB954] rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all shadow-lg hover:scale-105 hover:bg-[#1ed760]"
          >
